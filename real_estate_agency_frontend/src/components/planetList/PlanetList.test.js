...
describe('<PlanetList />', () => {
    it('renders if title and planets are not set', () => {
        const component = shallow(<PlanetList />);
        expect(component).toMatchSnapshot();
    });

    it('renders when title value is set', () => {
        const component = shallow(
            <Router history={history}>
                <PlanetList title={title} />
            </Router>
        );
    ...
    it('renders if both title and planets values are set', () => {
        const component = shallow(
            <Router history={history}>
                <PlanetList title={title} planets={planets} />
            </Router>
        );
